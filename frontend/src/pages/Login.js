...
function Login() {
    ...
    function onLogin() {
        axios.get(`http://abrams.seclab.cs.ucsb.edu:3030/auth/auth/${username}/${password}`).then((res) => {
            console.log("Success");
    ...
    const onRegister = async (e) => {
        ...
        try {
            const res = await axios.post(`http://abrams.seclab.cs.ucsb.edu:3030/auth/create/${username}/${password}`, post)
